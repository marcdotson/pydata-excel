...
**Data analytics** is the process of using data to **inform** business decision-making under uncertainty
...
::: {.fragment}
Most data analyses have two components: **visualizing data** and **modeling data**
:::
...
You need to understand the data you have so you can communicate about it and address its limitations
...
::: {.fragment}
Keep your data organized into **rows** (observations) and **columns** (variables) with a well-documented **data dictionary**
:::
...
"Individually separate and distinct" (**categorical** or qualitative)
...
"Forming an unbroken whole; without interruption" (**numeric** or quantitative)
...
::: {.column width="50%"}
- Visualize the distribution of a continuous variable by a discrete variable
- Insert a box plot
:::
...
Visualizations are suggestive, but we often need to use models to **extract information** from data
...
One of the most commonly used models is **linear regression**, often referred to as a **key driver analysis**
...
Another commonly used model is **logistic regression**, often used for **lead qualification** or **customer churn prediction**
...
- $\beta_0$ is the **intercept**, the log-odds of $y = 1$ when $x_1 \cdots x_p = 0$
...
# Try modeling your data. What do you uncover? What sort of recommendations can you make with the results? {background-color="#006242"}
...
# Good Luck! {background-color="#288DC2"}
